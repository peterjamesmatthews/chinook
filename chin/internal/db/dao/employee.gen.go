...
func newEmployee(db *gorm.DB, opts ...gen.DOOption) employee {
	...
	_employee.EmployeeID = field.NewInt32(tableName, "EmployeeId")
	...
	_employee.ReportsTo = field.NewInt32(tableName, "ReportsTo")
	_employee.BirthDate = field.NewTime(tableName, "BirthDate")
	_employee.HireDate = field.NewTime(tableName, "HireDate")
	_employee.Address = field.NewString(tableName, "Address")
	_employee.City = field.NewString(tableName, "City")
	_employee.State = field.NewString(tableName, "State")
	_employee.Country = field.NewString(tableName, "Country")
	_employee.PostalCode = field.NewString(tableName, "PostalCode")
	_employee.Phone = field.NewString(tableName, "Phone")
	_employee.Fax = field.NewString(tableName, "Fax")
...
func (e *employee) updateTableName(table string) *employee {
	...
	e.EmployeeID = field.NewInt32(table, "EmployeeId")
	e.LastName = field.NewString(table, "LastName")
	e.FirstName = field.NewString(table, "FirstName")
	e.Title = field.NewString(table, "Title")
	e.ReportsTo = field.NewInt32(table, "ReportsTo")
	e.BirthDate = field.NewTime(table, "BirthDate")
	e.HireDate = field.NewTime(table, "HireDate")
	...
	e.PostalCode = field.NewString(table, "PostalCode")
