...
func newCustomer(db *gorm.DB, opts ...gen.DOOption) customer {
	...
	_customer.CustomerID = field.NewInt32(tableName, "CustomerId")
	_customer.FirstName = field.NewString(tableName, "FirstName")
	_customer.LastName = field.NewString(tableName, "LastName")
	_customer.Company = field.NewString(tableName, "Company")
	_customer.Address = field.NewString(tableName, "Address")
	_customer.City = field.NewString(tableName, "City")
	_customer.State = field.NewString(tableName, "State")
	_customer.Country = field.NewString(tableName, "Country")
	_customer.PostalCode = field.NewString(tableName, "PostalCode")
	_customer.Phone = field.NewString(tableName, "Phone")
	_customer.Fax = field.NewString(tableName, "Fax")
	_customer.Email = field.NewString(tableName, "Email")
	_customer.SupportRepID = field.NewInt32(tableName, "SupportRepId")
...
func (c *customer) updateTableName(table string) *customer {
	...
	c.CustomerID = field.NewInt32(table, "CustomerId")
...
func (c *customer) fillFieldMap() {
	...
	c.fieldMap["CustomerId"] = c.CustomerID
	...
	c.fieldMap["PostalCode"] = c.PostalCode
	c.fieldMap["Phone"] = c.Phone
	c.fieldMap["Fax"] = c.Fax
	c.fieldMap["Email"] = c.Email
	c.fieldMap["SupportRepId"] = c.SupportRepID
}
